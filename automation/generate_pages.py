...
for city in cities:
    ...
    schema = {
        ...
        "name":city['name_en'], "description":f"Luxury heritage in {city['name_en']} curated by Planet&Travel"
    }
    html = template.render(
        ...
        body_content=f"In the heart of {city['name_en']}, whisper of maharajas...",
        faq_html='',
        related_cards=''
    )
