    ...
    <>
      ...
      <main>
          ...
          <div className="hero-content" style={{minHeight:'70vh'}}>
            <div className="max-w-7xl px-4">
              <h1 className="text-4xl md:text-6xl font-heading font-bold mb-4">
                <span className="text-gradient">Confirm Ticket</span>
              </h1>
              <p className="text-gradient-sub text-lg max-w-2xl mx-auto">
                Premium Confirm Ticket — curated by Planet&amp;Travel since 2000.
              </p>
            </div>
          </div>
        </section>
        <ServicePageSections
          ...
          description="Discover luxury Confirm Ticket with Planet&Travel."
