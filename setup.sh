#!/usr/bin/env bash
###############################################################################
# Planet&Travel – VISA ASSISTANCE PAGE (20‑Section Authority Build)
# Keywords: student visa, work visa, tourist visa, passport, forex
###############################################################################
set -euo pipefail
cd "$(dirname "$0")" || exit 1
...
WHATSAPP="919926665382"
TODAY=$(date +%Y-%m-%d)

# ── vercel.json + sitemap fix ──
cat > vercel.json <<'VERCELEOF'
{
  "headers": [
    {"source": "/sitemap.xml", "headers": [{"key": "Content-Type", "value": "application/xml"}, {"key": "Cache-Control", "value": "public, max-age=3600"}]},
...
# ── Visa Assistance Page – 20 Sections ──
cat > src/app/services/visa-assistance/page.tsx <<'ENDOFPAGE'
...
<url><loc>${SITE}/services/confirm-ticket/</loc><lastmod>${TODAY}</lastmod><priority>0.95</priority></url>
...
<url><loc>${SITE}/services/flight-booking/</loc><lastmod>${TODAY}</lastmod><priority>0.95</priority></url>
<url><loc>${SITE}/services/visa-assistance/</loc><lastmod>${TODAY}</lastmod><priority>0.95</priority></url>
...
<url><loc>${SITE}/concierge/</loc><lastmod>${TODAY}</lastmod><priority>0.9</priority></url>
...
SITEMAPEOF
cp public/sitemap.xml sitemap.xml 2>/dev/null || true
...
echo ""
echo "═══════════════════════════════════════════════════════════"
echo "✅ VISA ASSISTANCE PAGE – 20 sections, all intent keywords covered"
echo ""
echo "📊 20 SECTIONS BUILT:"
echo "   1.  Hero (all visa types + passport + forex keywords)"
echo "   2.  About Our Visa Services (E‑E‑A‑T authority)"
echo "   3.  Student Visa Services (8 countries, F1/Tier4/500 details)"
echo "   4.  Tourist Visa Table (10 destinations with docs/fees/processing)"
echo "   5.  Work Visa Services (6 countries: H1B/Express Entry/Blue Card)"
echo "   6.  Business Visa Services (6 countries)"
echo "   7.  Document Preparation (6‑card checklist)"
echo "   8.  Passport Assistance (PSK Gwalior, Tatkal, renewal)"
echo "   9.  Forex & Travel Insurance (3 cards)"
echo "   10. Why Choose Us (4‑card trust signals)"
echo "   11. How to Apply (3 steps)"
echo "   12. 2026 Visa Rule Changes (6 major updates)"
echo "   13. Visa Rejection Help (re‑application process)"
echo "   14. FAQ (10 schema‑ready items)"
echo "   15. Stats Banner"
echo "   16. Testimonials (6 real‑style reviews)"
echo "   17. Countries We Cover (50+ countries list)"
echo "   18. Booking CTA (WhatsApp + Phone)"
echo "   19. Complete Package (Visa+Flight+Forex+Insurance bundle)"
echo "   20. Visit Us"
echo ""
echo "🎯 KEYWORDS TARGETED:"
echo "   • visa agent Gwalior"
echo "   • student visa consultant Gwalior USA F1"
echo "   • UK student visa CAS letter agent Gwalior"
echo "   • Canada study permit SDS Gwalior"
echo "   • Australia student visa subclass 500 Gwalior"
echo "   • tourist visa Dubai Thailand Schengen Gwalior"
echo "   • work visa H1B Express Entry agent Gwalior"
echo "   • passport Tatkal agent Gwalior PSK"
echo "   • forex currency exchange Gwalior"
echo "   • visa rejection help Gwalior"
echo "   • business visa agent Gwalior"
echo "   • Schengen visa appointment booking Gwalior"
echo "═══════════════════════════════════════════════════════════"